...
<head>
    ...
    <!-- Propios estilos y JS -->
    <style type="text/css">
        #resultado {
            background-color: red;
            color: white;
            font-weight: bold;
            /*font: normal 15px/1.1em Arial,Sans-Serif;margin:0;*/
        }
        #resultado.ok {
    ...
    <script src="<?php echo e(asset('js/curp.js')); ?>"></script>
...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="container text-center col-sm-12 col-md-4 hidden-xs hidden-sm">
                <img src="<?php echo e(asset('logos/sepe.jpg')); ?>" align=center class="img-responsive"  width="80%" />
            </div>
            ...
            <div class="container text-center col-sm-12 col-md-4 hidden-xs hidden-sm">
                <img src="<?php echo e(asset('logos/uset.jpg')); ?>" align=center class="img-responsive"  width="70%" />
            </div>
	...
	<strong>Intranet de la Unidad de Servicios Educativos del Estado de Tlaxcala<br>
	Coordinación Estatal de Tecnología Educativa. Área de Desarrollo de Sistemas<br>
	<img src="http://sistemaintegral.septlaxcala.gob.mx/integral/images/tel.png"> (246) 46 23600. EXT 1015.  <img src="http://sistemaintegral.septlaxcala.gob.mx/integral/images/mail.png"> sistemas@septlaxcala.gob.mx</strong>
	</div>
	<!--
