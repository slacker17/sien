<div class="navbar-custom-menu pull-left">
    ...
    @if (Auth::check())
    <li><a><span>
	@if(Auth::user()->escuelasnormales)
	  {{ Auth::user()->escuelasnormales->nombre}}
            @if (Auth::user()->escuelasnormales->nombre_personaje != null)
               "{{(Auth::user()->escuelasnormales->nombre_personaje)}}"
            @endif
	@endif
     </span></a></li>
    @endif
