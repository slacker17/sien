...
class Grupo extends Model
{
    ...
    */
    ...
    protected $fillable = ['descripcion', 'idescuelanormal', 'idadministrativo', 'semestre', 'grupo', 'idcicloescolar', 'cursado', 'plan_id', 'licenciatura'];
    // protected $hidden = [];
    // protected $dates = [];
    ...
    */
    ...
    /* Get description + licenciatura (solo para cam) */
    public function getFullDescripcionAttribute(){
        return "{$this->descripcion} - ( {$this->licenciatura} )";
    }
